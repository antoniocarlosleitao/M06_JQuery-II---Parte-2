...
$(document).ready(function(){
   ...
   // console.log(titulos.first());
    ...
    $('.featured-item h4').dblclick(function(){  //o click altera a função do CSS. dbl = double
    ...
    //$('.featured-item a').on('click', function(event){ - blur para fazer a validação do campo do formulário 
